...
unsigned int  ACEventBuildMsg(unsigned char u8MsgCode,
                                   ...
                                   unsigned char *pu8Payload,
                                   unsigned short u16PayloadLen)
{
    AC_MessageHead *pstruMsg = NULL;
    unsigned short crc = 0;
    
    memmove((pu8Msg + sizeof(AC_MessageHead)), pu8Payload, u16PayloadLen);
    ...
    *pu16Len = (unsigned short)sizeof(AC_MessageHead) + u16PayloadLen;
    return SUCCESS;
}
